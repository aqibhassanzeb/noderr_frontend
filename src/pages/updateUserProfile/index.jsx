...
//       <div className="right_dashboard">
//         <div className="right_container">
//           <PageHeader page_title={"Edit Profile"} badge={"GM, Noderr"} profilePic={images.FakePic} />
//           {fetchLoading ? (
//             <div>
//               <LoadingModal />
//             </div>
...
//                   profilePic && (
//                     <div className="profile-pic-preview">
//                       <img src={URL.createObjectURL(profilePic)} alt="Profile Preview" className="w-20 h-20"/>
//                     </div>
//                   )
//                 )}
//               </div>
...
//       <div className="right_dashboard">
//         <div className="right_container">
//           <PageHeader page_title={"Edit Profile"} badge={"GM, Noderr"} profilePic={profilePic || images.FakePic} />
//           {fetchLoading ? (
//             <div>
//               <LoadingModal />
//             </div>
...
//                   <img
//                     src={profilePic && typeof profilePic === "string" ? profilePic : profilePic ? URL.createObjectURL(profilePic) : images.FakePic}
//                     alt="Profile Preview"
...
//                     <FaCopy className="h-5 w-5 text-gray-400" onClick={handleCopyWalletAddress}/>
//                   </div>
//               </div> */}
...
//                     name="wallet_address"
//                     id="wallet_address"
//                     className="block w-full h-[48px] pr-10 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm font-bold text-black"
//                     value={walletAddress}
//                     disabled={walletAddress ? true : false}
//                     onChange={(e) => setWalletAddress(e.target.value)}
//                   />
//                   <div className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onClick={handleCopyWalletAddress}>
