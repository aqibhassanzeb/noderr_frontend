  ...
  return (
    ...
    <Header/>
      ...
      <p>
        ...
        Noderrr for your own personal use subjected to restrictions set in these
      ...
      <p>
        ...
        Noderrr does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Noderrr,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Noderrr shall not be liable for the
      ...
      <p>
        You hereby grant Noderrr a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Noderrr; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Noderrr. Please include your name, your organization name,
