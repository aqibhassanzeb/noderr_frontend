  ...
  return (
    <div className="footer">
      ...
      <div id="w-node-_22aaa6c3-d6e7-05e0-eec1-5d107e13b5d4-ee31794f" className="fn-links-wrapper-2 flex items-center gap-2 p-1 pr-2">
        ...
        <a href="https://discord.gg/noderr" target="_blank" className="w-inline-block"><img src={require("./../../assets/images/3670325.png")} loading="lazy" style={{ width: "38px" }} alt srcSet={require("./../../assets/images/3670325.png")} className="image-14" /></a>
